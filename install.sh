...
(
  ...
  if [ -n "${VERSION:-}" ]; then
    DOWNLOAD_URL="https://github.com/gramlang/gram/releases/download/v$VERSION/$FILENAME"
  else
    DOWNLOAD_URL="https://github.com/gramlang/gram/releases/latest/download/$FILENAME"
  fi
