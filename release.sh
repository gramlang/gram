...
(
  ...
  cp artifacts/gram-x86_64-unknown-linux-gnu release/gram-x86_64-unknown-linux-gnu
  cp target/release/gram release/gram-x86_64-apple-darwin

  # Compute checksums of the artifacts.
  cd release
  shasum --algorithm 256 --binary gram-x86_64-apple-darwin > gram-x86_64-apple-darwin.sha256
  shasum --algorithm 256 --binary gram-x86_64-unknown-linux-gnu > gram-x86_64-unknown-linux-gnu.sha256

  # Verify the checksums.
  shasum --algorithm 256 --check --status gram-x86_64-apple-darwin.sha256
  shasum --algorithm 256 --check --status gram-x86_64-unknown-linux-gnu.sha256
